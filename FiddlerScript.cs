...
class Handlers
{
    ...
    */
    ...
    static function OnBeforeRequest(oSession: Session) {
		...
		if (m_ForceCORS && oSession.oRequest.headers.HTTPMethod == "OPTIONS") { 
			...
			oSession.oResponse.headers.Add("Access-Control-Allow-Methods", "GET, POST, PATCH, DELETE, OPTIONS");			
    ...
    */
    ...
    static function OnBeforeResponse(oSession: Session) {
        ...
        // Add or modify the CORS headers in the response
//        oSession.oResponse.headers.Add("Access-Control-Allow-Origin", "*");
//        oSession.oResponse.headers.Add("Access-Control-Allow-Methods", "GET, POST, PUT, DELETE, OPTIONS");
//        oSession.oResponse.headers.Add("Access-Control-Allow-Headers", "Content-Type, Accept");
//        oSession.oResponse.headers.Add("Access-Control-Allow-Credentials", "true");
		...
		if (m_ForceCORS && oSession.oRequest.headers.Exists("Origin")) { 
			...
			oSession.oResponse.headers.Add("Access-Control-Allow-Methods", "GET, POST, PUT, PATCH, DELETE, OPTIONS");
	
			oSession.oResponse.headers.Remove("Access-Control-Allow-Headers"); 
			oSession.oResponse.headers.Add("Access-Control-Allow-Headers", "Authorization, Origin, X-Requested-With, Content-Type, Accept");
